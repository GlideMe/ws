...
const honeybadger = require('../../../managers/honeybadger'); // THIS LINE ADDED BY GLIDE
...
class WebSocket extends EventEmitter {
  ...
  constructor (address, protocols, options) {
    ...
    // CUSTOM CODE FOR GLIDE
    this.on('error', function (msg, code) {
      console.log("WebSocket Error!", msg, code);
      honeybadger.send(
        new Error("SyncServer: Internal websocket error " + msg),
        {
          message: "SyncServer: Internal websocket error " + msg,
          url: address[0].url,
          options,
          protocols,
          address,
